...
import gb_retailapi_client.models
from gb_retailapi_client import rest
from gb_retailapi_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gb_retailapi_client.models, klass)
