...
class ProductDtoAvailableTime(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductDtoAvailableTime:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductDtoAvailableTime:
        """Create an instance of ProductDtoAvailableTime from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductDtoAvailableTime.parse_obj(obj)

        _obj = ProductDtoAvailableTime.parse_obj({
