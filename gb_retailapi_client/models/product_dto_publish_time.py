...
class ProductDtoPublishTime(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductDtoPublishTime:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductDtoPublishTime:
        """Create an instance of ProductDtoPublishTime from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductDtoPublishTime.parse_obj(obj)

        _obj = ProductDtoPublishTime.parse_obj({
