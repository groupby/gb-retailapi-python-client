...
class SearchResultsStats(BaseModel):
    """
    SearchResultsStats
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchResultsStats:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchResultsStats:
        """Create an instance of SearchResultsStats from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchResultsStats.parse_obj(obj)

        _obj = SearchResultsStats.parse_obj({
