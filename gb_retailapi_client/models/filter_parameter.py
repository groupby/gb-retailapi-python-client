...
class FilterParameter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilterParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilterParameter:
        """Create an instance of FilterParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilterParameter.parse_obj(obj)

        _obj = FilterParameter.parse_obj({
            "field": obj.get("field"),
            "value": obj.get("value"),
