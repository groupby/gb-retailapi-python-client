...
class RecommendationsErrorResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecommendationsErrorResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecommendationsErrorResponse:
        """Create an instance of RecommendationsErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecommendationsErrorResponse.parse_obj(obj)

        _obj = RecommendationsErrorResponse.parse_obj({
