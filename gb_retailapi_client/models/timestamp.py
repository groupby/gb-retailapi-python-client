...
class Timestamp(BaseModel):
    """
    Timestamp info with seconds and nanos.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Timestamp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Timestamp:
        """Create an instance of Timestamp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Timestamp.parse_obj(obj)

        _obj = Timestamp.parse_obj({
