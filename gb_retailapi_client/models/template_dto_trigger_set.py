...
class TemplateDtoTriggerSet(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemplateDtoTriggerSet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemplateDtoTriggerSet:
        """Create an instance of TemplateDtoTriggerSet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemplateDtoTriggerSet.parse_obj(obj)

        _obj = TemplateDtoTriggerSet.parse_obj({
