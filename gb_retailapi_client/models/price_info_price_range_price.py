...
class PriceInfoPriceRangePrice(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PriceInfoPriceRangePrice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PriceInfoPriceRangePrice:
        """Create an instance of PriceInfoPriceRangePrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PriceInfoPriceRangePrice.parse_obj(obj)

        _obj = PriceInfoPriceRangePrice.parse_obj({
