...
class ProductDtoPriceInfo(BaseModel):
    """
    ProductDtoPriceInfo
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductDtoPriceInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductDtoPriceInfo:
        """Create an instance of ProductDtoPriceInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductDtoPriceInfo.parse_obj(obj)

        _obj = ProductDtoPriceInfo.parse_obj({
